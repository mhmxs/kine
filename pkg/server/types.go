...
type Backend interface {
	...
	List(ctx context.Context, prefix, startKey string, limit, revision int64, labelSelector, fieldSelector string) (int64, []*KeyValue, error)
...
type Dialect interface {
	ListCurrent(ctx context.Context, prefix, startKey string, limit int64, includeDeleted bool, labelSelector, fieldSelector string) (*sql.Rows, error)
	List(ctx context.Context, prefix, startKey string, limit, revision int64, includeDeleted bool, labelSelector, fieldSelector string) (*sql.Rows, error)
